...
class IndividualExport extends PurchasedTicketExport
{
    ...
    protected function print_row(PurchasedTicket $purchasedTicket)
    {
        ...
        $fishing_licence_number = array_key_exists('fishing_licence_number', $data) ? $data['fishing_licence_number'] : ''; 
        $this->add_cell($fishing_licence_number);
