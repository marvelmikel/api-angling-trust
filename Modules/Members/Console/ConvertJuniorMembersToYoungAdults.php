...
class ConvertJuniorMembersToYoungAdults extends Command
{
    protected $signature = 'members:convert-junior-members-to-young-adults {offset=0} {--debug}';
    ...
    public function handle()
    {
        ...
        $members = Member::query()
            ...
            ->whereHas('meta', function(Builder $query) use ($offset) {
                $cutoff = now()->subYears(18)->subDays($offset);
