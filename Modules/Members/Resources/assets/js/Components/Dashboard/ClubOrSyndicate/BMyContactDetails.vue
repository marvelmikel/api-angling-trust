                ...
                <div class="container">
                    <div class="at-section__inner">
                        ...
                        <div class="info-items">
                            ...
                            <b-info-item label="Member Of" v-if="$root.member.at_member && !$root.member.fl_member" value="AT Only" />
                            <b-info-item label="Member Of" v-if="!$root.member.at_member && $root.member.fl_member" value="FL Only" />
                            <b-info-item label="Member Of" v-if="$root.member.at_member && $root.member.fl_member" value="AT & FL Combined" />
                            <br>
                            <b-info-item label="Name" :value="$root.member.meta.club_name" />
                            <b-info-item label="Size" :value="$root.member.category.slug" :options="options.category" />
                            <b-info-item label="Team Captain" :value="$root.member.meta.team_captain" />
                        </div>
            ...
            <div class="at-section">
                ...
                <div class="container">
                    <div class="at-section__inner">
                        ...
                        <div class="form-row">
                            <b-text-input
                                name="meta_team_captain"
                                label="Team Captain"
                                v-model="fields.meta.team_captain"
                            />
                        </div>
