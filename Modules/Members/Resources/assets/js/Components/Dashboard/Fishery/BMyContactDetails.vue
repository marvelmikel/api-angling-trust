            ...
            <div class="at-section">
                ...
                <div class="container">
                    <div class="at-section__inner">
                        <h3 class="at-heading is-grass">Fishery Details</h3>
                        ...
                        <div class="info-items">
                            ...
                            <b-info-item label="Category" :value="$root.member.category.slug" :options="options.category" />
                        </div>
            ...
            <div class="at-section">
                ...
                <div class="container">
                    <div class="at-section__inner">
                        ...
                        <button class="at-btn is-red is-solid"
                                @click="edit_mode = false"
                                :disabled="(!this.options.category.length) || is_submitting"
                        >Cancel
                        </button>
                        <button class="at-btn is-green is-solid"
                                @click="save"
                                :disabled="(!this.options.category.length) || is_submitting"
                        >Save
                        </button>
...
<script>
    import getFisheryCategories from "../../../fishery-categories";
    export default {
        async created() {
            this.options.category = await getFisheryCategories(this.$laravel_api, this.$root);
        },
        data() {
            return {
                is_submitting: false,
