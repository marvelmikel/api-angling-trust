                    ...
                    <div class="at-section__inner">
                        ...
                        <div class="info-items">
                            ...
                            <div class="b-info-item">
                                ...
                                <span class="value">{{ $root.member.meta.date_of_birth.day }}/{{ $root.member.meta.date_of_birth.month }}/{{ $root.member.meta.date_of_birth.year }}</span>
                            </div>

                            <b-info-item label="Gender" :value="$root.member.meta.gender" :options="$root.select_options.gender" />
                            <b-info-item label="Ethnicity" :value="$root.member.meta.ethnicity" :options="$root.select_options.ethnicity" />
                        ...
                        <h3 class="at-heading is-grass">Disability</h3>
                        ...
                        <div class="info-items">
                            <b-info-item
                                ...
                                :value="$root.member.meta.disability_1"
                        ...
                        <div class="info-items">
                            <b-info-item
                                ...
                                :value="$root.member.meta.disability_2"
                        ...
                        <div class="info-items">
                            <b-info-item
                                ...
                                :value="$root.member.meta.disability_3"
                        ...
                        <h3 class="at-heading is-grass">Address</h3>
                        ...
                        <template v-if="!$root.is_junior_member()">
                            <hr>
            ...
            <div class="at-section">
                ...
                <div class="container">
                    <div class="at-section__inner">
                        ...
                        <div class="form-row opt-ins" v-if="!$root.is_junior_member()">
                            <b-checkbox-input
    ...
    export default {
        ...
        methods: {
            edit() {
                ...
                if (!this.$root.member.meta.disability_3) {
                    this.fields.meta.disability_3.value = [];
                }
