<template>
    <div class="b-my-preferences">
        <template v-if="!edit_mode">
            <h3 class="at-heading is-blue">What type of angling do you take part in – tick all that apply</h3>
        ...
        <template v-if="edit_mode">
            <h3 class="at-heading is-blue">What type of angling do you take part in – tick all that apply <span class="required">*</span></h3>
