...
<script>
    export default {
        ...
        created() {
            this.$root.member.payment_is_recurring = true;
        },
        ...
        methods: {
            ...
            payment_complete(payment_is_recurring) {
                this.is_submitting = true;
                console.log('Completing Registration');
                console.log(payment_is_recurring);

                this.$laravel_api.post('members/me/complete', {
