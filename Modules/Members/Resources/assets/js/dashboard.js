...
Vue.component('b-trade-supporter-my-contact-details', require('./Components/Dashboard/TradeMember/BMyContactDetails.vue').default);
Vue.component('b-trade-supporter-my-preferences', require('./Components/Dashboard/TradeMember/BMyPreferences.vue').default);
...
Vue.component('b-ticket-list', require('./Components/Dashboard/BTicketList.vue').default);
Vue.component('b-ticket-list-ticket', require('./Components/Dashboard/BTicketListTicket.vue').default);

Vue.component('b-map-permission', require('./Components/Dashboard/BMapPermission.vue').default);
...
const app = new Vue({
    ...
    data() {
        return {
            is_loading: 0,
            member: null,
            upcoming_competitions: null,
            past_competitions: null,
            select_options: null,
            stripe_portal_loading: false
        }
    },
    ...
    methods: {
        ...
        open_stripe_portal() {
            this.stripe_portal_loading = true;

            this.$laravel_api.get('members/me/stripe-portal')
                .then(({data}) => {
                    if (data.success) {
                ...
                .catch(() => {
                    this.stripe_portal_loading = false;
                });
        }
    }
