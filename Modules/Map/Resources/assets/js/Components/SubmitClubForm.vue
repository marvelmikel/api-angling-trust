<template>
    <div class="submit-club-form">
        <div class="form-row">
            <b-location-input
                v-if="edit_mode !== ''"
                name="location"
                label="Location"
                icon="club-marker.svg"
        ...
        <div class="form-row">
            <b-text-input
                name="name"
                label="Name of Club or Syndicate"
                v-model="fields.name"
                required
            />
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                let endpoint = '/wp-json/barques/map/submit/club';

                if (this.edit_mode === '') {
                    endpoint = `/wp-json/barques/map/submit/club/${this.shop_id}`;
                }
            ...
            fill_fields(club) {
                ...
                this.$fields.fill_fields(this.fields, club);
            }
        }
    }
</script>
